...
## File: src/lib/i18n/intl.test.ts
```typescript
...
## File: tools/eslint-plugin/asset-lang.js
```javascript
// prettier-ignore
/* eslint-disable */
...
## File: tools/eslint-plugin/helpers.js
```javascript
/**
...
## File: tools/eslint-plugin/index.js
```javascript
...
## File: tools/eslint-plugin/lang.js
```javascript
...
## File: tools/eslint-plugin/utils.js
```javascript
...
## File: tools/eslint-plugin/rules/translate.js
```javascript
import fs from 'fs/promises'
import path from 'path'
