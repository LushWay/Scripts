...
declare class ChestFormData {
   ...
   * @param texture The type ID or the path to the texture. **YOU MUST INCLUDE THE ITEM PREFIX!** For vanilla it is
   *   `minecraft:`. Check `typeIds.js` for valid items & data values.
