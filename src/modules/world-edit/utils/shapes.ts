export const SHAPES: Record<string, string> = {
  ...
  'Квадратная пирамида': 'Math.abs(x) + Math.abs(y) - z <= 0',
  'Конус': 'Math.abs(Math.sqrt(x^2 + y^2)) + Math.abs(z) - zMin = 0',
  'Пирамида': 'y <= -(Math.abs(x) + Math.abs(z))',
  ...
  'outline':
    'Math.abs(x + xCenter - xMin) <= 0 || Math.abs(x + xCenter - xMax) <= 0 || Math.abs(y + yCenter - yMin) <= 0 || Math.abs(y + yCenter - yMax) <= 0 || Math.abs(z + zCenter - zMin) <= 0 || Math.abs(z + zCenter - zMax) <= 0',

  'hollow':
    'Math.abs(x + xCenter - xMin) > 0 && Math.abs(x + xCenter - xMax) > 0 && Math.abs(y + yCenter - yMin) > 0 && Math.abs(y + yCenter - yMax) > 0 && Math.abs(z + zCenter - zMin) > 0 && Math.abs(z + zCenter - zMax) > 0',

  'border_line':
    '((Math.abs(x + xCenter - xMin) <= 0 || Math.abs(x + xCenter - xMax) <= 0) && (Math.abs(y + yCenter - yMin) <= 0 || Math.abs(y + yCenter - yMax) <= 0))    ||    ((Math.abs(y + yCenter - yMin) <= 0 || Math.abs(y + yCenter - yMax) <= 0) && (Math.abs(z + zCenter - zMin) <= 0 || Math.abs(z + zCenter - zMax) <= 0))    ||    ((Math.abs(z + zCenter - zMin) <= 0 || Math.abs(z + zCenter - zMax) <= 0) && (Math.abs(x + xCenter - xMin) <= 0 || Math.abs(x + xCenter - xMax) <= 0))',
