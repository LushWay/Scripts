...
class SelectionBuilder {
    ...
    expand(amount) {
        ...
        if (dx < 0 && dz < 0) {
            ...
            WorldEditBuild.pos1 = XA.Utils.floorVector(WorldEditBuild.pos1).offset(amount, -amount, amount);
            WorldEditBuild.pos2 = XA.Utils.floorVector(WorldEditBuild.pos2).offset(-amount, amount, -amount);
        }
        else if (dx < 0 && dz >= 0) {
     ...
     */
    expandVert(amount) {
        WorldEditBuild.pos2 = XA.Utils.floorVector(WorldEditBuild.pos2).offset(0, amount, 0);
    }
}
