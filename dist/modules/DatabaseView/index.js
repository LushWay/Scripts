...
function changeValue(form, value) {
    ...
    if (value)
        typeDropdown.unshift("Оставить прежний §7(" + type + ")");
 ...
 * @returns A string.
 */
export function visualise_benchmark_result({ type = "test", timer_pathes = false, } = {}) {
    let output = "";
    let res = [];
