export const text = {
    ...
    "shop.notenought": (price, balance) => `§c☼ Недостаточно средств (Цена: §f${price} §c Баланс: §f${balance}§c)`,
    "shop.suc": (a, b, price, balance) => `§a☼ §fУспешная покупка ${a} х${b} §7(Цена: §f${price} §7 Баланс: §f${balance}§7)`,
    stats: (hrs, min, sec, ahrs, amin, asec, dhrs, dmin, dsec, kills, deaths, hget, hgive, bplace, Bbreak, fla) => `§8-----------------------------
