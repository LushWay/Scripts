...
`,
  ...
  replaces: [
    ...
    },
    {
      ...
      replace: `getComponent<N extends keyof BlockComponents>(
      componentName: N
    ): BlockComponents[N];`,
    },
    {
      find: 'getComponent(componentId: string): EntityComponent | undefined;',
      replace: `getComponent<N extends keyof EntityComponents>(
      componentName: N
    ): EntityComponents[N]`,
      all: true,
    },
    {
      ...
      replace: `getComponent<N extends keyof ItemComponents>(
      componentName: N
    ): ItemComponents[N]`,
    },
  ],
